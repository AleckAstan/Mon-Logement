...
var HotelDatepicker = (function () {
  ...
  var HotelDatepicker = function HotelDatepicker(input, options) {
    ...
    this.i18n = opts.i18n || {
      ...
      nights: "Jours",
      button: "Fermer",
      "checkin-disabled": "Desactiver",
      "checkout-disabled": "Desactiver",
      "day-names-short": ["Di", "Lu", "Ma", "Me", "Je", "Ve", "Sa"],
      "day-names": [
        "Dimanche",
        "Lundi",
        "Mardi",
  ...
  HotelDatepicker.prototype.showSelectedDays = function showSelectedDays() {
    ...
    for (var i = 0; i < days.length; i++) {
      ...
      if (
        ...
        (this$1.start &&
          !this$1.end &&
          this$1.getDateString(this$1.start, "YYYY-MM-DD") ===
            this$1.getDateString(time, "YYYY-MM-DD"))
      ) {
      ...
      if (
        this$1.end &&
        this$1.getDateString(this$1.end, "YYYY-MM-DD") ===
          this$1.getDateString(time, "YYYY-MM-DD")
      ) {
